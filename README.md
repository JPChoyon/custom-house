...
Production checklist: real app/auth URLs, approved scopes, persistent database/backups, deployed webhooks/extension, Online Store publication ID, verified existing metafield definitions, InkyBay host allowlist, rate limiting moved to shared storage for multi-instance hosting, and live development-store acceptance.
